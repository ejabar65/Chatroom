    ...
    try {
      ...
      if (error) {
        if (error.message.includes("provider") || error.message.includes("not enabled")) {
          setError("Google sign-in is not configured. Please enable Google OAuth in your Supabase dashboard.")
        } else {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription className="text-base">
            Sign in with your Google account to get help with homework
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground text-center">
            By signing in, you agree to help fellow students learn and follow our community guidelines
          </p>
        </CardContent>
      </Card>
    </div>
